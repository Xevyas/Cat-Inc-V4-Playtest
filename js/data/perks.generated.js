  ...
  "nodes": [
    {
      ...
      "jobId": "gang-leader",
      "name": "Leadership",
      "description": "Intrinsic Gang Leader leadership identity; the existing global Work-speed formula remains authoritative.",
      "starting": false,
      "granted": true,
      "available": true,
      "prerequisites": [],
    ...
    },
    {
      ...
      "jobId": "explorator",
      "name": "Pathfinder",
      "description": "Intrinsic Explorator identity; existing Exploration, Campaign and Scouting duration halving remains authoritative.",
      "starting": false,
      "granted": true,
      "available": true,
      "prerequisites": [],
    ...
    },
    {
      ...
      "jobId": "lumberjack",
      "name": "Gather Manager",
      "description": "Intrinsic Lumberjack manager identity for Wood Gathering remains authoritative.",
      "starting": false,
      "granted": true,
      "available": true,
      "prerequisites": [],
    ...
    },
    {
      ...
      "jobId": "farmer",
      "name": "Gather Manager",
      "description": "Intrinsic Farmer manager identity for Food Gathering remains authoritative.",
      "starting": false,
      "granted": true,
      "available": true,
      "prerequisites": [],
    ...
    },
    {
      ...
      "jobId": "miner",
      "name": "Gather Manager",
      "description": "Intrinsic Miner manager identity for Rock Gathering remains authoritative.",
      "starting": false,
      "granted": true,
      "available": true,
      "prerequisites": [],
    ...
    },
    {
      ...
      "description": "Intrinsic Carpenter manager identity for Wood Processing remains authoritative.",
      "starting": false,
      "granted": true,
      "available": true,
      "prerequisites": [],
    ...
    },
    {
      ...
      "jobId": "chef",
      "name": "Process Manager",
      "description": "Intrinsic Chef manager identity for Food Processing remains authoritative.",
      "starting": false,
      "granted": true,
      "available": true,
      "prerequisites": [],
    ...
    },
    {
      ...
      "jobId": "stonemason",
      "name": "Process Manager",
      "description": "Intrinsic Stonemason manager identity for Rock Processing remains authoritative.",
      "starting": false,
      "granted": true,
      "available": true,
      "prerequisites": [],
    ...
    },
    {
      ...
      "jobId": "builder",
      "name": "Builder",
      "description": "Intrinsic Builder identity as the Camp construction specialist.",
      "starting": false,
      "granted": true,
      "available": true,
      "prerequisites": [],
