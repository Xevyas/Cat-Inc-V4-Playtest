...
const LEGACY_SCENE_BEATS = Object.freeze({
  ...
  const QUICK_DIALOGUES = Object.freeze((DIALOGUE_CATALOG.quickDialogues || []).reduce(
    function(index, dialogue) {
      index[dialogue.id] = dialogue.text;
      return index;
    }, {}
  ));
